...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/flight/**").hasAnyRole("USER", "ADMIN")
                .requestMatchers( "/booking/**").hasAnyRole("USER", "ADMIN")
                .requestMatchers( "/passenger/**").hasAnyRole("USER", "ADMIN")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("https://flight-booking-front-end-rose.vercel.app"));
